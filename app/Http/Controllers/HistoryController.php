...
class HistoryController extends Controller
{
    ...
    public function getDates($user_id) {
        try {
            $histories = History::where('user_id', $user_id)->groupBy('date')->latest()->get(['date']);
    ...
    public function getSongs($user_id, Request $req) {
        try {
            $histories = History::where([['user_id', '=', $user_id], ['date', '=' ,$req->date]])->latest()->get();
    ...
    public function destroy(Request $req) {
        try {
            $histories = History::where([['user_id', '=', $req->user_id], ['date', '=' ,$req->date]])->get();
